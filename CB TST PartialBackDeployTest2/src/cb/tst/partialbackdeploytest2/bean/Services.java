package cb.tst.partialbackdeploytest2.bean;
...
public class Services implements CBBagKeys {
	...
	/**
	 * @servicename URN_PARTIALBACKDEPLOYTEST2_LIST_ALL_TABLES
	 * @param inBag
	 * @return
	 * @throws CBException
	 */
	public static CBBag listAllTables(CBBag inBag) throws CBException {
		...
		try {
			queryExecuter = new CBQueryExecuter("QE_URN_PARTIALBACKDEPLOYTEST2_LIST_ALL_TABLES");
			...
			eBag.put(NOTE, e.toString() + "Services.testService");
