...
public class DBSCompanyDebtFileResultFileExceptionPrmPOMData extends POMData {
	protected DBSCompanyDebtFileResultFileExceptionPrmPOMData() {
	}
	...
	static final POMDataFieldInfo fieldInfo = new POMDataFieldInfo(new short[] {
			...
			0, 0, 0, 0, 0, 0, 0, 0, 0 });
	private static final long iD = 3000012345700002L;
	...
	public boolean isChanged(Integer... arBagKeys) {
		DBSCompanyDebtFileResultFileExceptionPrmPOMData pomOrigin = (DBSCompanyDebtFileResultFileExceptionPrmPOMData) POMDataCache
	...
	public void copy(POMData data) {
		DBSCompanyDebtFileResultFileExceptionPrmPOMData cPOMData = (DBSCompanyDebtFileResultFileExceptionPrmPOMData) data;
		cPOMData.oID = oID;
	...
	public Object clone() {
		DBSCompanyDebtFileResultFileExceptionPrmPOMData clonePOMData = DBSCompanyDebtFileResultFileExceptionPrmPOMData
				.newInstance();
		copy(clonePOMData);
		return clonePOMData;
	}

	public static DBSCompanyDebtFileResultFileExceptionPrmPOMData newInstance() {
		DBSCompanyDebtFileResultFileExceptionPrmPOMData pomData = (DBSCompanyDebtFileResultFileExceptionPrmPOMData) POMDataPool
				.getFreePOMData(iD);
		if (pomData == null) {
			pomData = new DBSCompanyDebtFileResultFileExceptionPrmPOMData();
	...
	public static DBSCompanyDebtFileResultFileExceptionPrmPOMData newInstance(
		...
		DBSCompanyDebtFileResultFileExceptionPrmPOMData pomData = newInstance();
